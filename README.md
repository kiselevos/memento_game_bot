...
**Memento Game Bot** - Telegram-бот-игра на Go, которая создаёт раунды с забавными или ностальгическими заданиями, где участники делятся снимками, историями и голосуют за любимые ответы.
