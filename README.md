# 📸 Memento Game Bot — игра, которая делает нас ближе.

**Memento Game Bot** - Telegram-бот-игра на Go, которая создаёт раунды с забавными или ностальгическими заданиями, где участники делятся снимками, историями и голосуют за ответы.
Проект реализован как production-ready pet-project
---
...
- **Unit tests** (FSM, game manager)

## Ключевые технические особенности
- FSM для управления игровыми состояниями (round → vote → score)
- Разделение слоёв: handlers / services / repositories
